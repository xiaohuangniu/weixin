...
if(isset($_REQUEST["transaction_id"]) && $_REQUEST["transaction_id"] != ""){
	$n = new WxOrder();
	$input = $n->OrderRefund($_REQUEST["total_fee"], $_REQUEST["refund_fee"],$_REQUEST["transaction_id"]);
	printf_info($input);
	exit();
}
...
if(isset($_REQUEST["out_trade_no"]) && $_REQUEST["out_trade_no"] != ""){
	$n = new WxOrder();
	$input = $n->OrderRefund($_REQUEST["total_fee"], $_REQUEST["refund_fee"], '',$_REQUEST["out_trade_no"]);
	printf_info($input);
	exit();
}
?>
