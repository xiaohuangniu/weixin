...
require_once "WxPayOrderSelect.php";
$n = new WxOrder();
...
if(isset($_REQUEST["transaction_id"]) && $_REQUEST["transaction_id"] != ""){
	$input = $n->RetundSelect($_REQUEST["transaction_id"]);
	printf_info($input);
	exit();
}

if(isset($_REQUEST["out_trade_no"]) && $_REQUEST["out_trade_no"] != ""){
	$input = $n->RetundSelect($_REQUEST["out_trade_no"]);
	printf_info($input);
	exit();
}

if(isset($_REQUEST["out_refund_no"]) && $_REQUEST["out_refund_no"] != ""){
	$input = $n->RetundSelect($_REQUEST["out_refund_no"]);
	printf_info($input);
	exit();
}

if(isset($_REQUEST["refund_id"]) && $_REQUEST["refund_id"] != ""){
	$input = $n->RetundSelect($_REQUEST["refund_id"]);
	printf_info($input);
	exit();
}
